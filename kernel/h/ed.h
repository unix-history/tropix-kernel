 ...
 *			<sys/ed.h>				*
 *								*
 *	Definições para controlador ETHERNET estilo 3Com 3c503	*
 *								*
...
#define	ED_H			/* Para definir os protótipos */
...
struct ed_ring
{
	char	rsr;			/* receiver status */
	char	next_packet;		/* pointer to next packet	*/
	short	count;			/* bytes in packet (length + 4)	*/
};
